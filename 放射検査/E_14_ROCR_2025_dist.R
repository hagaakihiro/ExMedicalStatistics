...
data = read.csv("E14_1.csv")
ymax = 22
xmax = 14
hist(data$A,xlim=c(0,xmax), ylim=c(0,ymax), breaks=seq(-5,ymax,1),col = rgb(1, 0, 0, alpha = 0.5))
par(new=T)
#hist(data$B,xlim=c(0,12), ylim=c(0,ymax), breaks=seq(-1,10,0.5),col="red")
hist(data$B,xlim=c(0,xmax), ylim=c(0,ymax),breaks=seq(-5,ymax,1),col = rgb(0, 0, 1, alpha = 0.5))
#stop()
